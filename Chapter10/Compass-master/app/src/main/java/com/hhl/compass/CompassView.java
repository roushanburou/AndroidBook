...
public class CompassView extends View {
    ...
    public void setVal(float val) {
        this.val = val >= 0 ? val : Math.abs(val) + 180;
        invalidate();
    }
    ...
    private void drawInnerCircle() {
        ...
        mInnerShader = new RadialGradient(width/2,mOutSideRadius+mTextHeight,mCircumRadius-40, Color.parseColor("#828282"),
    ...
    private void drawCenterText() {
        ...
        mCanvas.drawText(centerText+"°",width/2-centerTextWidth/2-5,mTextHeight+mOutSideRadius+centerTextHeight/5-5,mCenterPaint);
    ...
    private void drawCompassDegreeScale() {
        ...
        //获取小刻度，3位数的宽度
        mSamllDegreePaint.getTextBounds("180",0,1,mThirdRect);
