package com.bkrc.listview.cursorloader;
...
import com.bkrc.listview.video.MediaItem;
import com.bkrc.listview.video.VideoAdapter;

import java.util.ArrayList;

public class CursorLoaderVideoLVActivity extends AppCompatActivity {
    ...
    private Handler handler = new Handler(){
        ...
        public void handleMessage(Message msg) {
            ...
            if(mediaItems != null && mediaItems.size()>0){
                // 有数据
                // 设置适配器
                video_lv.setAdapter(new VideoAdapter(CursorLoaderVideoLVActivity.this, mediaItems,true));
                // 把文本隐藏
    ...
    private void getDataFromLocal() {
        ...
        new Thread(){
            ...
            public void run() {
                super.run();
                ContentResolver resolver = CursorLoaderVideoLVActivity.this.getContentResolver();
    ...
    private class mOnClickListener implements AdapterView.OnItemClickListener {

        @Override
        public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
            MediaItem mediaItem = mediaItems.get(i);
            Toast.makeText(CursorLoaderVideoLVActivity.this, "当前选中的视频："+mediaItem.getName()
